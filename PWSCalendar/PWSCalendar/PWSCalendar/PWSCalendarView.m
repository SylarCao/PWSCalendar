...
- (PWSCalendarSegmentItem*) GetSegmentItemWithTitle:(NSString*)pTitle
{
    ...
    PWSCalendarSegmentItem* rt = [PWSCalendarSegmentItem CreateWithImage:nil HighLightedImage:nil Label:label LabelColor:[UIColor blackColor] LabelHighlightedColor:[UIColor greenColor]];
    return rt;
}
